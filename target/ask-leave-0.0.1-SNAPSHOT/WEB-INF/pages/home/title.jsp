...
//			alert((0-currLeft) <= maxOffset);
		...
		// sysadmin/Left.action   sysadmin/Main.action
		function toModule(moduleName){
			top.leftFrame.location.href = moduleName+'/Left.action';  //sysadminLeft.action
			top.main.location.href = moduleName+'/Main.action';       //sysadminMain.action
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		...
		您好：<strong>${userSession.userId}</strong>&nbsp;&nbsp;|
		<strong>
			${userInfoSession.name}
		</strong>&nbsp;&nbsp;
...
<div id="menuContent">
		<span id="topmenu" onclick="toModule('home');">系统首页</span><span id="tm_separator"></span>
			<shiro:hasPermission name="我要请假">
			<span id="topmenu" onclick="toModule('ask-leave');">我要请假</span><span id="tm_separator"></span>
			</shiro:hasPermission>
			<shiro:hasPermission name="审批管理">
			<span id="topmenu" onclick="toModule('approve');">审批管理</span><span id="tm_separator"></span>
			</shiro:hasPermission>
			<shiro:hasPermission name="用户管理">
			<span id="topmenu" onclick="toModule('aboutUser');">用户管理</span>
			</shiro:hasPermission>
</div>
