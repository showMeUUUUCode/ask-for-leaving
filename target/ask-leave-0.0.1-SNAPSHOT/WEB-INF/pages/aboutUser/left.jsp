	...
	<div class="sidebar_t">
        ...
        <div class="panel-content">
			<ul>
					...
					<li><a href="${ctx}/aboutUser/list" onclick="linkHighlighted(this)" target="main" id="aa_1">用户管理</a></li>
					<li><a href="${ctx}/aboutUser/role/list" onclick="linkHighlighted(this)" target="main" id="aa_1">角色管理</a></li>
			</ul>
        </div>
        </div>
    </div>
